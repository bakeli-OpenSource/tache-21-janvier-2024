...
const FilterCommandeEnCours = () => {
  ...
  const commandeEnCours = commandes.filter(commande => commande.etat === 'en cours');
  ...
  return (
    <div className={`${open ? 'md:ml-[225px]' : 'md:ml-[85px]'} m-4 `}>
      ...
      />
      <Table thead={table} tbody={commandeEnCours} actions={actions} />
    </div>
  );
}

export default FilterCommandeEnCours
