...
const AdminConnexion = ({ label, placeholder, value, onChange }) => {
  ...
  return (
        ...
        <div className='min-w-96 bg-white rounded-2xl shadow-2xl flex flex-col-reverse md:flex-row w-2/3 max-w-4xl'>
            <div className='md:w-3/5 py-5'>
              ...
              <div className='border-2 w-10 border-black inline-block mb-2'></div>
                <div className="relative mt-5 mb-7 flex flex-col justify-around">
                  <label
                    className={`absolute left-2 py-1 transition-all duration-300 flex  items-center text-center px-10 ${
              ...
              <div className="relative flex flex-col justify-around ">
                  <label
                    className={`absolute left-2 py-1 transition-all duration-300  flex flex-col items-center text-center px-4 ${
                      active || value || password !== "" ? 'text-sm text-black  transform -translate-y-5  ml-1 ' : ''
                    }`}
                    htmlFor='text'
                  >
                    Mot de passe 
                  ...
                  <input
                    ...
                    onBlur={handleRue}
                    className={`block md:w-96 min-w-80 px-2 ml-3 py-2 flex justify-around border text0 bg-gray-100 rounded-md shadow-sm focus:outline-none focus:border-black  focus:-border-black  ${
                      focused || value ?  'border-transparent' : 'border-gray-300'
                    }`}
                  ...
                  className='absolute right-7 bottom-3 flex justify-center items-center'/>
    ...
    //               <FaEyeSlash 
    //               onClick={updateShowPassword}
    //               className='absolute right-12 bottom-3 flex flex-col justify-center items-center'/>
