  ...
  return (
    <div className="min-h-[550px] flex justify-center items-center py-7 sm:py-0">
      <div className="container">
        ...
        >
          {/* image section */}
          <div className="bg-slate-800 rounded pb-3">
            <img
              src={women}
              alt="public"
          ...
          <div className="flex flex-col justify-center gap-6 sm:pt-0">
            ...
            <p className="text-sm text-gray-500 tracking-wide leading-5">
              Profitez de la commodité de commander depuis chez vous et
              laissez-nous vous livrer le meilleur, directement à votre porte.
              Avec notre engagement envers la satisfaction client et la qualité,
              votre expérience de magasinage en ligne n'a jamais été aussi
              agréable.
            </p>
