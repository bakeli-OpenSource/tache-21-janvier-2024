              ...
              <div className="grid grid-cols-1 sm:grid-cols-2">
                ...
                <div className="flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10">
                  ...
                  <div
                    ...
                    data-aos-delay="300"
                  > 
                  <Link to={"/boutique"} className="bg-black">
                    <ComponentButton className='bg-slate-800 text-white  px-3 py-2 my-5 text-xl tracking-widest rounded' texte='Voir Boutique '/>
                  </Link>   
                  </div>
                </div>
                {/* section image */}
